...
class CUBDataset(Dataset):
    ...
    def __init__(self, opts):
        ...
        for rel_index, index in enumerate(self.train_list):
        ...
        print('using %d classes, %d images' % (len(self.train_list), len(self.index_list)))
        ...
        self.total_frames = len(self.index_list)
    ...
    def __getitem__(self, raw_index):
        batch_id = raw_index // self.samples_per_iter
        item_id = raw_index % self.samples_per_iter
        class_id, img_id = self.sample_list[batch_id][item_id]
